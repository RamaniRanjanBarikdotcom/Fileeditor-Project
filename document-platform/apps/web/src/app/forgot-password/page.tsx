  ...
  return (
    <div className="flex min-h-[75vh] items-center justify-center px-5">
      <div className="card w-full max-w-md p-8">
        <Mail className="mb-5 h-10 w-10 text-indigo-500" />
        <h1 className="ts-h2 mb-3">Reset your password</h1>
        <p className="mb-7 text-sm leading-6" style={{ color: 'var(--text-muted)' }}>
        ...
        <Link
          href="/login"
          className="mt-6 flex items-center gap-2 text-sm font-semibold text-indigo-500"
        >
