  ...
  return (
    <div className="flex min-h-[75vh] items-center justify-center px-5">
      <div className="card w-full max-w-md p-8">
        <Lock className="mb-5 h-10 w-10 text-indigo-500" />
        <h1 className="ts-h2 mb-6">Choose a new password</h1>
        {done ? (
          <div>
            <p className="rounded-xl bg-emerald-500/10 p-4 text-sm text-emerald-500">
